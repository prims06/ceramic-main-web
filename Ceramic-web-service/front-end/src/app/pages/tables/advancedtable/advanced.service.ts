...
export class AdvancedService {
    ...
    private url = "http://localhost:3000/scan";

  
    fetchAll(): Observable<Table[]>{
      return this.http.get<Table[]>(this.url, {responseType: "json"}).pipe(
...
data: Table[]= [];
     ...
     * Returns the value
     */
    get tables$() { return this.http.get<Table[]>(this.url, {responseType: "json"}).pipe(
        tap((_) => 
